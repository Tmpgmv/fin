...
public interface UserRole {
    ...
    @EntityAttributePolicy(entityClass = Transfer.class, attributes = "*", action = EntityAttributePolicyAction.MODIFY)
    @EntityPolicy(entityClass = Transfer.class, actions = EntityPolicyAction.ALL)
    void transfer();

    @EntityAttributePolicy(entityClass = Wallet.class, attributes = "*", action = EntityAttributePolicyAction.MODIFY)
